...
function convertKanaIntoRoman(outputArea, targetCity){
  var romanTable = {
    //'ﾎｯｶｲﾄﾞｳ'
    'ﾎ':'Ho', 
  };
  var pTag = document.createElement('P');
  pTag.textContent = hankana2zenkana(targetCity);
  outputArea.appendChild(pTag);
}
window.alert(hankana2zenkana('ﾋﾞﾎﾛﾁｮｳ'));
console.error(outputArea);
var pTag = document.createElement('P');
console.error(pTag);
console.error(opt_input.value);
pTag.textContent = hankana2zenkana(opt_input.value);
console.error(pTag);
outputArea.appendChild(pTag);
